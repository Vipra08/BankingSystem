                ...
                while (true)
                {
                    ...
                    static void AccountMenu(BankAccount account)
                    {
                        while (true)
                        {
                            ...
                            {
                                case "1":
                                    // show numeric balance without currency symbol to avoid missing-symbol characters
                                ...
                                case "4":
                                    ...
                                    {
                                        // replace any Unicode replacement char with a dollar sign to avoid question marks in console
                                        Console.WriteLine(transaction.Replace("\uFFFD", "$"));
                                    }
                                    break;
                                case "5":
                                    return;
